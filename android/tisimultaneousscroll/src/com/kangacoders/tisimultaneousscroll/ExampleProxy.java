...
// This proxy can be created by calling Tisimultaneousscroll.createExample({message: "hello world"})
@Kroll.proxy(creatableInModule=TisimultaneousscrollModule.class)
